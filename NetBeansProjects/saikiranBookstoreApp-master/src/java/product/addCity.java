...
public class addCity extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addCity</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addCity at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (city.equals("")){
            ...
            try {
                ...
                String sqlInsertCity = "INSERT INTO  `SaiKiran enterprises`.`city` (`company-id` ,`company-name`)VALUES (NULL ,  '"+city+"');";  
                ...
                int rows = st.executeUpdate(sqlInsertCity);
                
                if (rows != 1){
                    out.println("City not inserted");
                }else {
                    out.println(city+" Product City Inserted");
                }
                st.close();
                con.close();
